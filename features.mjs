...
export function renderHome(root, posts) {
 ...
 <section class="personality-promo" aria-labelledby="personality-promo-title"><span class="personality-promo-icon" aria-hidden="true">✳</span><div><p class="eyebrow">A compact adaptive profile</p><h2 id="personality-promo-title">A personality map with room for contradiction.</h2><p>Explore a detailed profile across temperament, relationships, motives, values, identity and everyday life, with a shorter route that keeps every construct represented.</p></div><div class="personality-promo-action"><span>ABOUT 45–70 MIN · SAVE LOCALLY</span><a class="button" href="#personality">Build my profile ↗</a></div></section>
