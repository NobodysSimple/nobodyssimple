...
export function renderHome(root, posts) {
 ...
 <section class="personality-promo" aria-labelledby="personality-promo-title"><span class="personality-promo-icon" aria-hidden="true">✳</span><div><p class="eyebrow">A full profile experience</p><h2 id="personality-promo-title">A personality map with room for contradiction.</h2><p>Explore a full profile across temperament, relationships, motives, values, identity and everyday life, then read the evidence behind its playful story-title.</p></div><div class="personality-promo-action"><span>ABOUT 80–100 MIN · SAVE LOCALLY</span><a class="button" href="#personality">Build my full profile ↗</a></div></section>
