...
export function renderHome(root, posts) {
 ...
 <section class="personality-promo" aria-labelledby="personality-promo-title"><span class="personality-promo-icon" aria-hidden="true">✳</span><div><p class="eyebrow">A new beta experience</p><h2 id="personality-promo-title">A personality map with room for contradiction.</h2><p>Explore a first profile, then see the separate patterns and hypotheses behind its playful name.</p></div><div class="personality-promo-action"><span>ABOUT 10–15 MIN · NO TIMER</span><a class="button" href="#personality">Build my personality map ↗</a></div></section>
